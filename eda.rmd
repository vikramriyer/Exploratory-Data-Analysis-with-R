...
### And it turns out that, commonly wine has pH range between 2.9 to 3.9. Let's verify if this is true in our dataset

```{r}
length(wine$pH[ wine$pH > 2.9 & wine$pH < 3.9 ])
```

### Whoa! Out of the total 1599 observations, 1585 are in the range that we expected them to be in. You can refer to 'ref link 1' below
