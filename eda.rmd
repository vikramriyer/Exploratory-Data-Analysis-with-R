...
```{r}
#The variable 'X' in the dataframe is just the index and we wont be using it throughout the exploration, let's get rid of it.
wine$X <- NULL
...
best <- wine$quality > 6
wine$quality.category <- factor(ifelse(low, 'low', ifelse(medium, 'medium', 'best')), 
...
ggpairs(wine, title = 'bivariate red wine analysis', 
